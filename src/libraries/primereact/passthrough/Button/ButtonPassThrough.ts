  ...
  root: ({ props, context }) => ({
    className: classNames(
      //severity null && not link, text, outlined, plain - link
      {
        ...
        'text-primary': props.link && props.severity === null,
      },
      //severity
      {
      ...
      {
        'border-transparent': props.text && !props.plain,
        'button-primary-text': props.text && props.severity === null,
      ...
      //outlined && not plain, outlined && severity not plain,
      {
        ...
        'button-primary-outlined': props.outlined && props.severity === null,
